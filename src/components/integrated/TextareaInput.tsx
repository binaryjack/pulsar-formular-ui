/**
 * TextareaInput integrated component
 * Full-featured textarea with label, errors, and helper text
 *
 * @example
 * ```tsx
...
import { FTextareaField } from '../primitives';

/**
 * TextareaInput component
 * Integrated textarea with label and validation errors
 */
export const TextareaInput = ({
  ...
  return (
    <div className={`form-field ${className}`} data-field={name}>
      ...
      <FTextareaField name={name} className={hasErrors ? 'border-red-500' : ''} />
