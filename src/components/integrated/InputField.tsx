...
import { FInputField } from '../primitives/FInputField';

/**
 * InputField - Integrated text input component
 *
 * A FieldSet wrapper that combines:
 * - Label element
 * - FInputField primitive
 * - ValidationResults
 ...
 */
export function InputField(props: IFieldSetProps) {
